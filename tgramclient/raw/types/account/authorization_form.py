...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <tgramclient.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <tgramclient.raw.base.SecureValue>`):
            N/A
