...
class BoostsStatus(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.premium.BoostsStatus`.
    ...
    Parameters:
        ...
        premium_audience (:obj:`StatsPercentValue <tgramclient.raw.base.StatsPercentValue>`, *optional*):
            N/A

        prepaid_giveaways (List of :obj:`PrepaidGiveaway <tgramclient.raw.base.PrepaidGiveaway>`, *optional*):
            N/A
