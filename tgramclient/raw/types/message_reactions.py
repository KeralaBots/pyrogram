...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <tgramclient.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <tgramclient.raw.base.MessagePeerReaction>`, *optional*):
            N/A
