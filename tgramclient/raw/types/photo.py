...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <tgramclient.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <tgramclient.raw.base.VideoSize>`, *optional*):
            N/A
