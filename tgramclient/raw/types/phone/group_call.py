...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <tgramclient.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <tgramclient.raw.base.GroupCallParticipant>`):
            N/A
