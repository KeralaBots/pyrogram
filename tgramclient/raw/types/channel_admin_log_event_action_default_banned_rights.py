...
class ChannelAdminLogEventActionDefaultBannedRights(TLObject):  # type: ignore
    ...
    Parameters:
        prev_banned_rights (:obj:`ChatBannedRights <tgramclient.raw.base.ChatBannedRights>`):
            N/A

        new_banned_rights (:obj:`ChatBannedRights <tgramclient.raw.base.ChatBannedRights>`):
            N/A
