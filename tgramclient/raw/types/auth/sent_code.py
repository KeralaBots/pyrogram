...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <tgramclient.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <tgramclient.raw.base.auth.CodeType>`, *optional*):
            N/A
