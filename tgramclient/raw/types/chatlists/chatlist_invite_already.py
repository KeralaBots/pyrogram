...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <tgramclient.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <tgramclient.raw.base.Peer>`):
            N/A
