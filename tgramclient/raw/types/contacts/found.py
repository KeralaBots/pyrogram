...
class Found(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results (List of :obj:`Peer <tgramclient.raw.base.Peer>`):
            N/A

        results (List of :obj:`Peer <tgramclient.raw.base.Peer>`):
            N/A
