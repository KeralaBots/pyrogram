...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <tgramclient.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <tgramclient.raw.base.PopularContact>`):
            N/A
