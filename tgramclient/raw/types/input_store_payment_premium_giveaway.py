...
class InputStorePaymentPremiumGiveaway(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.InputStorePaymentPurpose`.
    ...
    Parameters:
        boost_peer (:obj:`InputPeer <tgramclient.raw.base.InputPeer>`):
            N/A
        ...
        additional_peers (List of :obj:`InputPeer <tgramclient.raw.base.InputPeer>`, *optional*):
            N/A
