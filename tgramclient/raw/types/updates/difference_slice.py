...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <tgramclient.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <tgramclient.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <tgramclient.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <tgramclient.raw.base.updates.State>`):
            N/A
