...
class ChatAdminsWithInvites(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.messages.ChatAdminsWithInvites`.
    ...
    Parameters:
        admins (List of :obj:`ChatAdminWithInvites <tgramclient.raw.base.ChatAdminWithInvites>`):
            N/A
