...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <tgramclient.raw.base.SearchResultsPosition>`):
            N/A
