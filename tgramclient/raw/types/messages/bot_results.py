...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <tgramclient.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <tgramclient.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <tgramclient.raw.base.InlineBotWebView>`, *optional*):
            N/A
