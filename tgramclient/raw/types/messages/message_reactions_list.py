...
class MessageReactionsList(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.messages.MessageReactionsList`.
    ...
    Parameters:
        ...
        reactions (List of :obj:`MessagePeerReaction <tgramclient.raw.base.MessagePeerReaction>`):
            N/A
