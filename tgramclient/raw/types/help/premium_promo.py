...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <tgramclient.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <tgramclient.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <tgramclient.raw.base.PremiumSubscriptionOption>`):
            N/A
