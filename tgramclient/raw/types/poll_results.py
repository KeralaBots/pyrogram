...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <tgramclient.raw.base.PollAnswerVoters>`, *optional*):
            N/A

        total_voters (``int`` ``32-bit``, *optional*):
            N/A

        recent_voters (List of :obj:`Peer <tgramclient.raw.base.Peer>`, *optional*):
            N/A

        solution (``str``, *optional*):
            N/A

        solution_entities (List of :obj:`MessageEntity <tgramclient.raw.base.MessageEntity>`, *optional*):
            N/A
