...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <tgramclient.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <tgramclient.raw.base.PhoneConnection>`):
            N/A
