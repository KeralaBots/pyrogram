...
class AllStories(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~tgramclient.raw.base.stories.AllStories`.
    ...
    Parameters:
        ...
        peer_stories (List of :obj:`PeerStories <tgramclient.raw.base.PeerStories>`):
            N/A
        ...
        stealth_mode (:obj:`StoriesStealthMode <tgramclient.raw.base.StoriesStealthMode>`):
            N/A
