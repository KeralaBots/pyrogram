...
class UpdateBotMessageReaction(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        actor (:obj:`Peer <tgramclient.raw.base.Peer>`):
            N/A

        old_reactions (List of :obj:`Reaction <tgramclient.raw.base.Reaction>`):
            N/A

        new_reactions (List of :obj:`Reaction <tgramclient.raw.base.Reaction>`):
            N/A
