...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        file (:obj:`InputFile <tgramclient.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <tgramclient.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <tgramclient.raw.base.VideoSize>`, *optional*):
            N/A
